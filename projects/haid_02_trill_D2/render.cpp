...
bool setup(BelaContext *context, void *userData)
{
	...
	gMinHapticOscFreqSliderId = controller.addSlider("[min] Haptic OSC F",15 , gHapticOscFreqRange[0], gHapticOscFreqRange[1], 1);	// Frequency of haptic oscillator
	gMaxHapticOscFreqSliderId = controller.addSlider("[max]Haptic OSC F",50 , gHapticOscFreqRange[0], gHapticOscFreqRange[1], 1);	// Frequency of haptic oscillator
